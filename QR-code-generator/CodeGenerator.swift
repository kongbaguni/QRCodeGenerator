...
struct CodeGenerator {
    static func makeQRUIImage (text:String, colorA:CIColor, colorB:CIColor) -> UIImage? {
    ...
    static func makeQRImage (text:String, colorA:Color, colorB:Color) -> Image {
        if let image = makeQRUIImage(text: text, colorA: colorA.ciColorValue, colorB: colorB.ciColorValue) {
    ...
    static func makeBarcodeUiImage(text:String, colorA:CIColor, colorB:CIColor)->UIImage?{
        guard let data = text.data(using: .utf8) ,
    ...
    static func makeBarcodeImage(text:String, colorA:Color, colorB:Color)->Image {
        if let uiimage = makeBarcodeUiImage(text: text, colorA: colorA.ciColorValue, colorB: colorB.ciColorValue) {
